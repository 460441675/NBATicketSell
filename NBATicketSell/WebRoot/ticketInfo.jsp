				...
				<div class="tab-pane active" id="horizontal-form">
					<form class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.ticketName"
									value="${requestScope.ticket.ticketName}" class="form-control1"
									id="focusedinput" placeholder="票名">
							</div>
							<!-- <div class="col-sm-2">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.fixture"
									value="${requestScope.ticket.fixture}" class="form-control1"
									id="focusedinput" placeholder="比赛时间">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.venue"
									value="${requestScope.ticket.venue}" class="form-control1"
									id="focusedinput" placeholder="比赛地点">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.highPrice"
									value="${requestScope.ticket.highPrice}" class="form-control1"
									id="focusedinput" placeholder="一等座价">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.middlePrice"
									value="${requestScope.ticket.middlePrice}" class="form-control1"
									id="focusedinput" placeholder="二等座价">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.lowPrice"
									value="${requestScope.ticket.lowPrice}" class="form-control1"
									id="focusedinput" placeholder="三等座价">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.highStorage"
									value="${requestScope.ticket.highStorage}" class="form-control1"
									id="focusedinput" placeholder="一等座存">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.middleStorage"
									value="${requestScope.ticket.middleStorage}" class="form-control1"
									id="focusedinput" placeholder="二等座存">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.lowStorage"
									value="${requestScope.ticket.lowStorage}" class="form-control1"
									id="focusedinput" placeholder="三等座存">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">一等座售</label>
							<div class="col-sm-8">
								<input type="text" name="ticket.highSoldNum"
									value="${requestScope.ticket.highSoldNum}" class="form-control1"
									id="focusedinput" placeholder="一等座售">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">二等座售</label>
							<div class="col-sm-8">
								<input type="text" name="ticket.middleSoldNum"
									value="${requestScope.ticket.middleSoldNum}" class="form-control1"
									id="focusedinput" placeholder="二等座售">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">三等座售</label>
							<div class="col-sm-8">
								<input type="text" name="ticket.lowSoldNum"
									value="${requestScope.ticket.lowSoldNum}" class="form-control1"
									id="focusedinput" placeholder="三等座售">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.onSaleTime"
									value="${requestScope.ticket.onSaleTime}" class="form-control1"
									id="focusedinput" placeholder="上架时间">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
									...
									<div class="col-sm-8"><textarea name="ticket.details" id="txtarea1" cols="50" rows="4" class="form-control1">${requestScope.ticket.details}</textarea></div>
								</div>
					</form>
				</div>
			</div>
