...
<body>
	<div id="wrapper">
		...
		<ul class="nav navbar-nav navbar-right">
			<li class="dropdown"><a href="#" class="dropdown-toggle avatar"
				...
				<ul class="dropdown-menu">
					...
					<li class="m_2"><a href="Order_queryOrderByUserId_myOrder"><i class="fa fa-usd"></i>我的订单<span
		...
		<div class="bs-example4" data-example-id="contextual-table">
			添加订单成功 继续<a href="index.jsp">订票</a>, 前往<a href="Order_queryOrderByUserId_myOrder?user.userId=<s:property value="#session.user.userId" />">我的订单</a>
		</div>
