  	...
  	<!-- <h3 align="center">个人信息</h3> -->
			<div class="tab-content">
				<div class="tab-pane active" id="horizontal-form">
					<form class="form-horizontal" action="Ticket_updateTicket_main?ticket.ticketId=${requestScope.ticket.ticketId }" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.highPrice"
									...
									id="focusedinput" placeholder="一等座价" onkeyup="this.value=this.value.replace(/[^\d]/g,'')">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.middlePrice"
									...
									id="focusedinput" placeholder="二等座价" onkeyup="this.value=this.value.replace(/[^\d]/g,'')">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.lowPrice"
									...
									id="focusedinput" placeholder="三等座价" onkeyup="this.value=this.value.replace(/[^\d]/g,'')">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.highStorage"
									...
									id="focusedinput" placeholder="一等座存" onkeyup="this.value=this.value.replace(/[^\d]/g,'')">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.middleStorage"
									...
									id="focusedinput" placeholder="二等座存" onkeyup="this.value=this.value.replace(/[^\d]/g,'')">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="ticket.lowStorage"
									...
									id="focusedinput" placeholder="三等座存" onkeyup="this.value=this.value.replace(/[^\d]/g,'')">
							</div>
							<!-- <div class="col-sm-2">
										<p class="help-block">Your help text!</p>
									</div> -->
