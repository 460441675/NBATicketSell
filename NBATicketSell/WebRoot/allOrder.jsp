...
<div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="index.html"><i class="fa fa-dashboard fa-fw nav_icon"></i>主页</a>
                        </li>
                        <li>
    ...
    <table class="table">
				...
				<tbody>
					<s:iterator value="#request.pageBean.orderList" id="order">
						<tr class="success" align="center">
							<td><s:property value="#order.ticket.ticketName" /></td>
							<th scope="row"><s:property value="#order.consignee" /></th>
							...
							<td><a href="Order_deleteOrderByAdmin_allOrder?order.orderId=<s:property value="#order.orderId" />">删除</a></td>
							<td><a href="User_findOrderById_orderInfo?order.orderId=<s:property value="#order.orderId" />">修改</a></td>
						</tr>
					</s:iterator>
				</tbody>
			</table>
		...
		<s:else>
			...
			<s:else>
				<a href="Order_queryAllOrder_allOrder">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a
					href="Order_queryAllOrder_allOrder?page=<s:property value="#request.pageBean.currentPage - 1"/>">上一页</a>
			</s:else>

			<s:if
				test="#request.pageBean.currentPage != #request.pageBean.totalPage">
				<a
					href="Order_queryAllOrder_allOrder?page=<s:property value="#request.pageBean.currentPage + 1"/>">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a
					href="Order_queryAllOrder_allOrder?page=<s:property value="#request.pageBean.totalPage"/>">尾页</a>
			</s:if>
	...
	<center>
		<form action="Order_queryAllOrder_allOrder" onsubmit="return validate();">
